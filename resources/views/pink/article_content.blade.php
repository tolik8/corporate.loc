<div id="content-single" class="content group">
	<div class="hentry hentry-post blog-big group ">
		...
		<div class="meta group">
			<p class="author"><span>by <a href="#" title="{{ $article->created_at->format('M') }}" rel="author">{{ $article->user->name }}</a></span></p>
			...
			<p class="comments"><span><a href="#comments" title="Comment on This is the title of the first article. Enjoy it.">{{ count($article->comments) ?? '0' }} {{ Lang::choice('ru.comments', count($article->comments)) }}</a></span></p>
		</div>
		<!-- post content -->
	...
	<div id="comments">
		...
		<ol class="commentlist group">
			...
			<li class="comment bypostauthor odd">
				<div class="comment-container">
					<div class="comment-author vcard">
						<img alt="" src="{{ asset(env('THEME')) }}/images/avatar/nicola.jpeg" class="avatar" height="75" width="75" />
